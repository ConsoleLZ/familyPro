	...
	return function(t) {
		...
		t.exports = function(t, e) {
			var n, i, p, v, _, b, g, m, y, O = t.target,
				...
				S = w ? c : c[O] || l(c, O, {})[O],
				E = S.prototype;
			for (v in e) n = s(w ? v : O + (j ? "." : "#") + v, t.forced), i = !n && x && d(x, v),
				b = S[v], i && (t.dontCallGetSet ? (y = u(x, v), g = y && y.value) : g = x[v]), _ =
				i && g ? g : e[v], i && typeof b == typeof _ || (m = t.bind && i ? f(_, r) : t
					.wrap && i ? h(_) : A && a(_) ? o(_) : _, (t.sham || _ && _.sham || b && b
					.sham) && l(m, "sham", !0), l(S, v, m), A && (p = O + "Prototype", d(c, p) || l(
						c, p, {}), l(c[p], v, _), t.real && E && !E[v] && l(E, v, _)))
		}
	}, function(t, e, n) {
		"use strict";
		...
		var r = n(2),
			...
			b = function() {
				var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
					...
					r = !1;
				return "boolean" == typeof t.useMasterKey ? r = t.useMasterKey : "boolean" == typeof f
					._config.useMasterKey && (r = f._config.useMasterKey), r ? f.masterKey ? e ? n[
						"X-LC-Sign"] = v(f.masterKey, !0) : n["X-LC-Key"] = "".concat(f.masterKey,
						",master") : (console.warn("masterKey is not set, fall back to use appKey"), _(
						n, e)) : _(n, e), f.hookKey && (n["X-LC-Hook-Key"] = f.hookKey), null !== f
					._config.production && (n["X-LC-Prod"] = String(f._config.production)), n[
					"X-LC-UA"] = f._sharedConfig.userAgent, o.default.resolve().then(function() {
						var e = h(t);
						if (e) n["X-LC-Session"] = e;
						else if (!f._config.disableCurrentUser) return f.User.currentAsync().then(
							function(t) {
								return t && t._sessionToken && (n["X-LC-Session"] = t
									._sessionToken), n
							});
						return n
					})
			...
			m = function(t) {
				var e = t.service,
					...
					d = t.signKey,
					h = void 0 === d || d;
				if (!f.applicationId || !f.applicationKey && !f.masterKey) throw new Error(
					"Not initialized");
				...
				return b(c, h).then(function(t) {
					return p({
						...
						if (e.rawMessage = e.rawMessage || e.error, !f._sharedConfig
							.keepErrorRawMessage) {
							var n, o;
							e.error += (0, i.default)(n = (0, i.default)(o = " ["
								.concat(t.statusCode || "N/A", " ")).call(o, r,
								" ")).call(n, _, "]")
						}
			...
			y = function(t, e, n, r, i, o, a) {
				var u = "";
				if (t && (u += "/".concat(t)), e && (u += "/".concat(e)), n && (u += "/".concat(n)),
					i && i._fetchWhenSave) throw new Error("_fetchWhenSave should be in the query");
		...
		"function" != typeof /./ && "object" != typeof Int8Array && "function" != typeof a && (o =
			function(t) {
		...
		var r = n(2),
			...
			f = function() {
				var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
					...
					r = t.includeACL,
					o = {};
				return e && (o.keys = c(e).join(",")), n && (o.include = c(n).join(",")), r && (o
					.returnACL = r), o
			},
			l = function(t) {
				return t.sessionToken ? t.sessionToken : t.user && "function" == typeof t.user
					.getSessionToken ? t.user.getSessionToken() : void 0
			},
			d = function(t) {
				return function(e) {
					return t(e), e
			...
			p = function(t, e, n) {
				...
				return r = e && e.hasOwnProperty("constructor") ? e.constructor : function() {
					...
					}, u.extend(r, t), h.prototype = t.prototype, r.prototype = new h, e && u.extend(r
						.prototype, e), n && u.extend(r, n), r.prototype.constructor = r, r.__super__ =
					t.prototype, r
			},
		...
		e.f = r ? o ? function(t, e, n) {
			if (a(t), e = u(e), a(n), "function" == typeof t && "prototype" === e && "value" in n &&
		...
		var r, i = n(21),
			...
			v = function() {
				var t, e = c("iframe");
				return e.style.display = "none", s.appendChild(e), e.src = String("javascript:"), t = e
					.contentWindow.document, t.open(), t.write(h("document.F=Object")), t.close(), t.F
			},
			_ = function() {
				try {
		...
		u[l] = !0, t.exports = Object.create || function(t, e) {
			var n;
			return null !== t ? (d.prototype = i(t), n = new d, d.prototype = null, n[l] = t) : n =
				_(), void 0 === e ? n : o.f(n, e)
		}
	}, function(t, e) {
		t.exports = {}
	}, function(t, e, n) {
		...
		t.exports = r ? o : function(t) {
			var e, n, r;
			return void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof(n = f(e =
					s(t), u)) ? n : c ? o(e) : "Object" == (r = o(e)) && i(e.callee) ? "Arguments" :
				r
		}
	}, function(t, e, n) {
		var r = n(117),
		...
		function r(t, e, n) {
			e = Object(i.a)(e, n);
			for (var r = !Object(o.a)(t) && Object(a.a)(t), u = (r || t).length, s = Array(u), c =
				0; c < u; c++) {
				var f = r ? r[c] : c;
				s[c] = e(t[f], f, t)
			}
			...
			O._sharedConfig = {
				...
				if (t)
					if (t.userAgent) e = t.userAgent;
						...
						var n = t.name;
						t.version && (n += "/".concat(t.version)), t.extra && (n += "; "
							.concat(t.extra)), e += " (".concat(n, ")")
					} O._sharedConfig.userAgent = e
			}), O._getAVPath = function(t) {
				if (!O.applicationId) throw new Error(
					"You need to call AV.initialize before using AV.");
				if (t || (t = ""), !l.isString(t)) throw new Error(
				...
				return O.localStorage.getItemAsync(t).then(function(e) {
					return O._installationId = e, O._installationId ? e : (O
						._installationId = e = d(), O.localStorage.setItemAsync(t,
							e).then(function() {
							return e
						}))
				})
				...
				return O.localStorage.getItemAsync(t).then(function(e) {
					return O._subscriptionId = e, O._subscriptionId || (e = O
						._refreshSubscriptionId(t)), e
				})
				...
				if (t instanceof O.Object) {
					...
					return e && !l.include(e, t) && t._hasData ? t._toFullJSON((0, o.default)(e)
						.call(e, t), r) : t._toPointer()
				}
				...
				var e = function(t) {
					return t && t._toFullJSON && (t = t._toFullJSON([])), l.mapObject(t,
						function(t) {
							return O._encode(t, [])
						})
				};
				...
				return t instanceof O.Relation || t instanceof O.File ? e(t) : l.isArray(t) ? (l
					.each(t, function(r, i) {
		...
		function i() {
			return !("undefined" == typeof window || !window.process || "renderer" !== window.process
					.type && !window.process.__nwjs) || ("undefined" == typeof navigator || !navigator
					.userAgent || !navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/)) &&
		...
		function a() {
			var t;
			return "object" === ("undefined" == typeof console ? "undefined" : r(console)) && console
				.log && (t = console).log.apply(t, arguments)
		}
		...
		], t.exports = n(375)(e), t.exports.formatters.j = function(t) {
			try {
		...
		var r = n(2),
			...
			c = s(a, {
				...
				getAdapter: function(t) {
					...
					if (void 0 === e) throw new Error("".concat(t,
						" adapter is not configured"));
					return e
				},
				setAdapters: function(t) {
					var e = this;
					o.extend(this._adapters, t), (0, i.default)(o).call(o, t).forEach(function(
						n) {
						return e.emit(n, t[n])
					})
				}
		...
		var r, i, o = n(9),
			...
			f = c && c.v8;
		f && (r = f.split("."), i = r[0] > 0 && r[0] < 4 ? 1 : +(r[0] + r[1])), !i && a && (!(r = a
				.match(/Edge\/(\d+)/)) || r[1] >= 74) && (r = a.match(/Chrome\/(\d+)/)) && (i = +r[1]),
			t.exports = i
	}, function(t, e, n) {
		var r = n(16);
		...
		t.exports = Object.setPrototypeOf || ("__proto__" in {} ? function() {
			var t, e = !1,
				n = {};
			try {
				t = r(Object.getOwnPropertyDescriptor(Object.prototype, "__proto__").set), t(n,
		...
		var r, i, o, a = n(254),
			...
			g = function(t) {
				return function(e) {
					var n;
					if (!c(e) || (n = i(e)).type !== t) throw v("Incompatible receiver, " + t +
						" required");
					return n
				}
			};
		...
		var r = n(22),
			...
			a = Object(r.a)(function(t, e) {
				var n = a.placeholder,
					r = function() {
						for (var o = 0, a = e.length, u = Array(a), s = 0; s < a; s++) u[s] = e[
							s] === n ? arguments[o++] : e[s];
		...
		var r = n(50),
			...
			f = function(t) {
				...
				return function(p, v, _, b) {
					for (var g, m, y = a(p), O = o(y), w = r(v, _), j = u(O), A = 0, x = b || s, S =
							e ? x(p, j) : n || d ? x(p, 0) : void 0; j > A; A++)
		...
		var r = n(2),
			...
			g = function(t) {
				var e = t.method,
					...
					y = t.onprogress;
				if (r) {
					var O, w, j, A = (0, o.default)(O = (0, a.default)(w = (0, u.default)(r)).call(w,
						function(t) {
							var e, n = r[t];
							if (void 0 !== n) {
								var o = "object" === (0, i.default)(n) ? (0, s.default)(n) : n;
								return (0, c.default)(e = "".concat(encodeURIComponent(t), "="))
				...
				var S = _("request"),
					E = S(n, {
						...
						if (h("response(%d) %d %O %o", x, t.status, t.data || t.text, t.header), !
							1 === t.ok) {
							var e = new Error;
						...
						throw t.response && (d.enabled("leancloud:request") || p(
								"request(%d) %s %s %o %o %o", x, e, n, r, f, g), p(
								"response(%d) %d %O %o", x, t.response.status, t.response
								.data || t.response.text, t.response.header), t.statusCode = t
							.response.status, t.responseText = t.response.text, t.response = t
							.response.data), t
					});
				return m ? l(E, m) : E
			};
		...
		t.exports = function(t, e, n, a, p, _, j) {
			...
			var A, x, S, E = function(t) {
				...
				U = !y && I || E(p),
				k = "Array" == e ? N.entries || I : I;
			if (k && (A = c(k.call(new t))) !== Object.prototype && A.next && (o || c(A) === m || (
					f ? f(A, m) : u(A[O]) || h(A, O, w)), l(A, C, !0, !0), o && (v[C] = w)), b &&
				"values" == p && I && "values" !== I.name && (!o && g ? d(N, "name", "values") : (
					T = !0, U = function() {
						return i(I, this)
					})), p)
				if (x = {
					...
					for (S in x) !y && !T && S in N || h(N, S, x[S]);
				else r({
					target: e,
					proto: !0,
					forced: y || T
				}, x);
			return o && !j || N[O] === U || h(N, O, U, {
				name: p
			}), v[e] = U, x
		}
	}, function(t, e, n) {
		...
		var r, i, o, a = n(4),
			...
			h = l("iterator"),
			p = !1;
		[].keys && (o = [].keys(), "next" in o ? (i = c(c(o))) !== Object.prototype && (r = i) : p = !
			0), void 0 == r || a(function() {
				var t = {};
				return r[h].call(t) !== t
		...
		m && y || (m = function(t) {
				...
				w.now(T(t))
			} : A && !b ? (o = new A, a = o.port2, o.port1.onmessage = N, i = c(a.postMessage, a)) :
			u.addEventListener && f(u.postMessage) && !u.importScripts && r && "file:" !== r
			.protocol && !d(I) ? (i = I, u.addEventListener("message", N, !1)) : i =
			"onreadystatechange" in v("script") ? function(t) {
		...
		function i(t, e) {
			...
			var n = o.n.length,
				...
				c = "constructor";
			for (Object(u.a)(t, c) && !e.contains(c) && e.push(c); n--;)(c = o.n[n]) in t && t[c] !== s[
				c] && !e.contains(c) && e.push(c)
		}
		e.a = i;
		var o = n(3),
			a = n(26),
		...
		function r(t, e, n) {
			return null == t ? i.a : Object(o.a)(t) ? Object(f.a)(t, e, n) : Object(a.a)(t) && !Object(u
				.a)(t) ? Object(s.a)(t) : Object(c.a)(t)
		}
		e.a = r;
		var i = n(129),
			o = n(26),
		...
		function r(t, e, n) {
			return function(r, u, s) {
				var c = 0,
					f = Object(i.a)(r);
				if ("number" == typeof s) t > 0 ? c = s >= 0 ? s : Math.max(s + f, c) : f = s >= 0 ?
					Math.min(s + 1, f) : s + f + 1;
		...
		function r(t, e, n) {
			if (null == e || n) return Object(i.a)(t) || (t = Object(a.a)(t)), t[Object(s.a)(t.length -
				1)];
		...
		e.a = Object(r.a)(function(t, e) {
			var n = {},
				r = e[0];
			if (null == t) return n;
			Object(i.a)(r) ? (e.length > 1 && (r = Object(o.a)(r, e[1])), e = Object(a.a)(t)) :
				(r = u.a, e = Object(s.a)(e, !1, !1), t = Object(t));
		...
		function r(t, e, n, r) {
			...
			for (var s = [], c = [], f = 0, l = Object(a.a)(t); f < l; f++) {
				var d = t[f],
					h = n ? n(d, f, t) : d;
				e && !n ? (f && c === h || s.push(d), c = h) : n ? Object(u.a)(c, h) || (c.push(h), s
					.push(d)) : Object(u.a)(s, d) || s.push(d)
			}
			return s
		}
		e.a = r;
			...
			concat: function(t) {
				...
				for (e = -1, r = arguments.length; e < r; e++)
					if (o = -1 === e ? a : arguments[e], g(o))
						for (i = s(o), c(h + i), n = 0; n < i; n++, h++) n in o && f(d, h,
							o[n]);
					else c(h + 1), f(d, h++, o);
				return d.length = h, d
			}
		...
		var a = Object.prototype.hasOwnProperty,
			u = "~";
		Object.create && (r.prototype = Object.create(null), (new r).__proto__ || (u = !1)), o.prototype
			.eventNames = function() {
				var t, e, n = [];
				...
				if (f.fn) {
					...
					for (c = 0; c < h; c++) switch (f[c].once && this.removeListener(t, f[c].fn, void 0,
						...
						default:
							if (!s)
								for (d = 1, s = new Array(l - 1); d < l; d++) s[d - 1] = arguments[
									d];
				...
				if (a.fn) a.fn !== e || i && !a.once || n && a.context !== n || (0 == --this
					._eventsCount ? this._events = new r : delete this._events[o]);
				else {
					for (var s = 0, c = [], f = a.length; s < f; s++)(a[s].fn !== e || i && !a[s]
						.once || n && a[s].context !== n) && c.push(a[s]);
				...
				var e;
				return t ? (e = u ? u + t : t, this._events[e] && (0 == --this._eventsCount ? this
					._events = new r : delete this._events[e])) : (this._events = new r, this
					._eventsCount = 0), this
		...
		e.getAsync = function(t) {
			var e;
			return t = (0, i.default)(e = "AV/".concat(u.applicationId, "/")).call(e, t), a
				.getItemAsync(t).then(function(e) {
					return c(e, t)
				})
			...
			return "number" == typeof n && (s.expiredAt = Date.now() + n), a.setItemAsync((0, i
					.default)(r = "AV/".concat(u.applicationId, "/")).call(r, t), (0, o.default)
				(s))
		}
	}, function(t, e, n) {
		var r = n(380);
		...
		var n = {
			...
			bin: {
				...
				bytesToString: function(t) {
					for (var e = [], n = 0; n < t.length; n++) e.push(String.fromCharCode(t[
					n]));
					return e.join("")
				}
			}
		...
		var r = n(2),
			...
			o = n(1),
			a = n(59);
		a._ = o, a.version = n(217), a.Promise = i.default, a.localStorage = n(219), a.Cache = n(220), a
			.Error = n(40), n(382), n(436)(a), n(437)(a), n(438)(a), n(439)(a), n(444)(a), n(445)(a), n(
				500)(a), n(526)(a), n(527)(a), n(529)(a), n(530)(a), n(531)(a), n(532)(a), n(533)(a), n(
				534)(a), n(535)(a), n(536)(a), n(537)(a), a.Conversation = n(538), n(539), t.exports = a
	}, function(t, e, n) {
		var r = n(239);
		n(73), t.exports = r
	}, function(t, e, n) {
		...
		var r = n(0),
			...
			y = function(t, e) {
				var n, r = arguments.length > 2 ? arguments[2] : void 0,
					u = i(O, this);
				a ? n = a(new g, u ? o(this) : O) : (n = u ? this : s(O), c(n, b, "Error")), void 0 !==
					e && c(n, "message", p(e)), _ && c(n, "stack", l(n.stack, 1)), d(n, r);
				var f = [];
				return h(t, m, {
					that: f
				}), c(n, "errors", f), n
		...
		t.exports = !r(function() {
			var t = Error("a");
			return !("stack" in t) || (Object.defineProperty(t, "stack", i(1, 7)), 7 !== t
				.stack)
		})
	}, function(t, e, n) {
		var r = n(9),
		...
		var r, i, o, a = n(0),
			...
			q = C.f,
			W = q,
			B = !!(L && L.createEvent && c.dispatchEvent),
			V = function(t) {
				var e;
			...
			Q = function(t, e) {
				var n, r, i, o = e.value,
					...
					l = t.domain;
				try {
					u ? (a || (2 === e.rejection && H(e), e.rejection = 1), !0 === u ? n = o : (l && l
						.enter(), n = u(o), l && (l.exit(), i = !0)), n === t.promise ? c(M(
						"Promise-chain cycle")) : (r = V(n)) ? f(r, n, s, c) : s(n)) : c(o)
				} catch (t) {
					l && !i && l.exit(), c(t)
				}
			},
			...
			z = function(t, e, n) {
				var r, i;
				B ? (r = L.createEvent("Event"), r.promise = e, r.reason = n, r.initEvent(t, !1, !0), c
					.dispatchEvent(r)) : r = {
					promise: e,
					reason: n
				}, !N && (i = c["on" + t]) ? i(r) : "unhandledrejection" === t && w(
			...
			J = function(t) {
				f(y, c, function() {
					var e, n = t.facade,
						...
						i = G(t);
					if (i && (e = j(function() {
							s ? F.emit("unhandledRejection", r, n) : z(
		...
		if (T && (R = function(t) {
				...
				var n = U(this),
					r = q(m(this, R));
				return n.parent = !0, r.ok = !_(t) || t, r.fail = _(e) && e, r.domain = s ? F
					.domain : void 0, 0 == n.state ? n.reactions.add(r) : O(function() {
						Q(r, n)
					}), r.promise
			}), i = function() {
				var t = new r,
			...
			}, !u && _(S) && P !== Object.prototype)) {
			o = P.then, I || l(P, "then", function(t, e) {
				var n = this;
		...
		A || (r = function() {
			...
			o = void 0, t && t.enter()
		}, v || g || b || !m || !y ? !_ && w && w.resolve ? (c = w.resolve(void 0), c
			.constructor = w, f = d(c.then, c), a = function() {
				f(r)
			}) : g ? a = function() {
			O.nextTick(r)
		} : (p = d(p, l), a = function() {
			...
			f = function(t) {
				return function(e, n) {
					var r, f, l = o(a(e)),
						d = i(n),
						h = l.length;
					return d < 0 || d >= h ? t ? "" : void 0 : (r = s(l, d), r < 55296 || r >
						56319 || d + 1 === h || (f = s(l, d + 1)) < 56320 || f > 57343 ? t ? u(
							l, d) : r : t ? c(l, d, d + 2) : f - 56320 + (r - 55296 << 10) +
						65536)
				}
			};
		t.exports = {
		...
		function r(t) {
			if (null == t) return !0;
			var e = Object(i.a)(t);
			return "number" == typeof e && (Object(o.a)(t) || Object(a.a)(t) || Object(u.a)(t)) ? 0 ===
				e : 0 === Object(i.a)(Object(s.a)(t))
		}
		e.a = r;
		var i = n(27),
			o = n(46),
		...
		function i(t, e, n, o) {
			...
			if (!g) {
				...
				var m = t.constructor,
					y = e.constructor;
				if (m !== y && !(Object(f.a)(m) && m instanceof m && Object(f.a)(y) &&
					y instanceof y) && "constructor" in t && "constructor" in e) return !1
			}
			n = n || [], o = o || [];
		...
		function i(t, e, n) {
			...
			var i = RegExp([(e.escape || u).source, (e.interpolate || u).source, (e.evaluate || u)
					.source
				].join("|") + "|$", "g"),
				s = 0,
				l = "__p+='";
		...
		function r(t, e, n) {
			...
			n || (n = {});
			var c = function() {
					s = !1 === n.leading ? 0 : Object(i.a)(), r = null, u = t.apply(o, a), r || (o = a =
						null)
				},
				f = function() {
					var f = Object(i.a)();
					s || !1 !== n.leading || (s = f);
					var l = e - (f - s);
					return o = this, a = arguments, l <= 0 || l > e ? (r && (clearTimeout(r), r = null),
						s = f, u = t.apply(o, a), r || (o = a = null)) : r || !1 === n.trailing || (
						r = setTimeout(c, l)), u
				};
		...
		function r(t, e, n) {
			var r, a, u, s, c, f = function() {
					var i = Object(o.a)() - a;
					e > i ? r = setTimeout(f, e - i) : (r = null, n || (s = t.apply(c, u)), r || (u =
						c = null))
				},
				l = Object(i.a)(function(i) {
					return c = this, u = i, a = Object(o.a)(), r || (r = setTimeout(f, e), n && (s =
						t.apply(c, u))), s
				});
		...
		e.a = Object(r.a)(function(t, e, n) {
			var r, s;
			return Object(i.a)(e) ? s = e : (e = Object(u.a)(e), r = e.slice(0, -1), e = e[e
				.length - 1]), Object(o.a)(t, function(t) {
				var i = s;
				if (!i) {
		...
		function r(t) {
			return t ? Object(i.a)(t) ? o.q.call(t) : Object(a.a)(t) ? t.match(l) : Object(u.a)(t) ?
				Object(s.a)(t, c.a) : Object(f.a)(t) : []
		}
		e.a = r;
		var i = n(46),
			o = n(3),
		...
		e.a = Object(r.a)(function(t, e) {
			...
			return Object(i.a)(r) ? (r = Object(o.a)(r), e.length > 1 && (n = e[1])) : (e =
				Object(a.a)(Object(u.a)(e, !1, !1), String), r = function(t, n) {
		...
		function r(t, e, n) {
			return null == t || t.length < 1 ? null == e || n ? void 0 : [] : null == e || n ? t[t
				.length - 1] : Object(i.a)(t, Math.max(0, t.length - e))
		}
		e.a = r;
		var i = n(205)
	}, function(t, e, n) {
		...
		Object(i.a)(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"], function(t) {
			...
			r.a.prototype[t] = function() {
				...
				return null != n && (e.apply(n, arguments), "shift" !== t && "splice" !==
					t || 0 !== n.length || delete n[0]), Object(a.a)(this, n)
			}
		...
		t.exports = function(t) {
			var e;
			return r(t) && (e = t.constructor, i(e) && (e === s || r(e.prototype)) ? e = void 0 : o(
				e) && null === (e = e[u]) && (e = void 0)), void 0 === e ? s : e
		}
	}, function(t, e, n) {
		var r = n(357);
		t.exports = r
		...
		function n(t, e) {
			var n = e || 0,
				i = r;
			return [i[t[n++]], i[t[n++]], i[t[n++]], i[t[n++]], "-", i[t[n++]], i[t[n++]], "-", i[t[
				n++]], i[t[n++]], "-", i[t[n++]], i[t[n++]], "-", i[t[n++]], i[t[n++]], i[t[
				n++]], i[t[n++]], i[t[n++]], i[t[n++]]].join("")
		}
		...
		function r(t) {
			...
			function r(t) {
				function n() {
					if (n.enabled) {
						...
						var o = n,
							u = Number(new Date),
							s = u - (a || u);
						o.diff = s, o.prev = a, o.curr = u, a = u, e[0] = r.coerce(e[0]), "string" !=
				...
				return n.namespace = t, n.enabled = r.enabled(t), n.useColors = r.useColors(), n.color =
					e(t), n.destroy = i, n.extend = o, "function" == typeof r.init && r.init(n), r
					.instances.push(n), n
			}
			...
			return r.debug = r, r.default = r, r.coerce = c, r.disable = u, r.enable = a, r.enabled = s,
				r.humanize = n(376), Object.keys(t).forEach(function(e) {
					r[e] = t[e]
		...
		function r(t) {
			var e = Math.abs(t);
			return e >= c ? Math.round(t / c) + "d" : e >= s ? Math.round(t / s) + "h" : e >= u ? Math
				.round(t / u) + "m" : e >= a ? Math.round(t / a) + "s" : t + "ms"
		}

		function i(t) {
			var e = Math.abs(t);
			return e >= c ? o(t, e, c, "day") : e >= s ? o(t, e, s, "hour") : e >= u ? o(t, e, u,
				"minute") : e >= a ? o(t, e, a, "second") : t + " ms"
		}
		...
		s.init = function(t) {
				...
				if (i && console.warn("MasterKey is not supposed to be used at client side."), _(e) && !
					f && v(s._config.serverURLs)) throw new TypeError(
				...
				e !== s._config.applicationId ? (s._config.masterKey = i, s._config.hookKey = o) : (i &&
						(s._config.masterKey = i), o && (s._config.hookKey = o)), s._config
					.applicationId = e, s._config.applicationKey = n, l(y) || s.setProduction(y),
					void 0 !== d && (s._config.disableCurrentUser = d);
				var w = g || void 0 !== f;
				if (w || (s._appRouter = new c(s)), s._setServerURLs(h({}, r(e), s._config.serverURLs,
						"string" == typeof f ? b(f) : f), w), O) s._config.realtime = O;
				...
				"string" != typeof t ? h(s._config.serverURLs, t) : s._config.serverURLs = b(t), e && (s
					._appRouter ? s._appRouter.disable() : g = !0)
			...
			}, s.initialize = s.init, ["applicationId", "applicationKey", "masterKey", "hookKey"]
			.forEach(function(t) {
		...
		r({
			...
			slice: function(t, e) {
				var n, r, l, d = c(this),
					...
					g = u(t, p),
					m = u(void 0 === e ? p : e, p);
				if (i(d) && (n = d.constructor, o(n) && (n === _ || i(n.prototype)) ? n =
						void 0 : a(n) && null === (n = n[v]) && (n = void 0), n === _ ||
						void 0 === n)) return h(d, g, m);
				for (r = new(void 0 === n ? _ : n)(b(m - g, 0)), l = 0; g < m; g++, l++)
					g in d && f(r, l, d[g]);
				return r.length = l, r
			}
		})
		...
		r.prototype.disable = function() {
			...
			if (!(this.disabled || Date.now() < this.lockedUntil)) {
				...
				return i({
					...
					console.warn("refresh server URLs failed: ".concat(e.message)), t.lock(
						600)
				})
			}
		}, t.exports = r
		...
		n(210), n(92), n(393), n(400), n(401), n(402), n(403), n(229), n(404), n(405), n(406), n(407),
			n(408), n(409), n(410), n(411), n(412), n(413), n(414), n(415);
		var r = n(13);
		t.exports = r.Symbol
	}, function(t, e, n) {
		...
		var r = n(0),
			...
			it = function(t, e, n) {
				t === B && it(Z, e, n), h(t);
				var r = v(e);
				return h(n), l(X, r) ? (n.enumerable ? (l(t, F) && t[F][r] && (t[F][r] = !1), n = g(n, {
					enumerable: b(0, !1)
				})) : (l(t, F) || G(t, F, b(1, {})), t[F][r] = !0), nt(t, r, n)) : G(t, r, n)
			},
			ot = function(t, e) {
				h(t);
				var n = p(e),
			...
			ut = function(t) {
				var e = v(t),
					n = o($, this, e);
				return !(this === B && l(X, e) && !l(Z, e)) && (!(n || !l(this, e) || !l(X, e) || l(
					this, F) && this[F][e]) || n)
			},
			st = function(t, e) {
				var n = p(t),
				...
				if (n !== B || !l(X, r) || l(Z, r)) {
					var i = J(n, r);
					return !i || !l(X, r) || l(n, F) && n[F][r] || (i.enumerable = !0), i
				}
			},
			ct = function(t) {
				var e = H(p(t)),
		...
		c || (V = function() {
			...
			var t = arguments.length && void 0 !== arguments[0] ? _(arguments[0]) : void 0,
				e = I(t),
				n = function(t) {
					this === B && o(n, Z, t), l(this, F) && l(this[F], e) && (this[F][e] = !1),
						nt(this, e, b(1, t))
				};
			return s && et && nt(B, e, {
				configurable: !0,
			...
			return rt(I(t), t)
		}), S.f = ut, A.f = it, x.f = ot, j.f = st, y.f = O.f = ct, w.f = ft, k.f = function(
		t) {
			return rt(U(t), t)
		}, s && (G(Q, "description", {
			configurable: !0,
		...
		var r = n(65),
			...
			o = n(111).f,
			a = n(396),
			u = "object" == typeof window && window && Object.getOwnPropertyNames ? Object
		...
		var r = n(112),
			...
			u = Math.max;
		t.exports = function(t, e, n) {
			for (var s = i(t), c = r(e, s), f = r(void 0 === n ? s : n, s), l = a(u(f - c, 0)), d =
					0; c < f; c++, d++) o(l, d, t[c]);
			return l.length = d, l
		}
	}, function(t, e, n) {
			...
			t.Events = {
				on: function(t, n, r) {
					...
					for (t = t.split(e), i = this._callbacks || (this._callbacks = {}), o =
						t.shift(); o;) s = i[o], a = s ? s.tail : {}, a.next = u = {}, a
						.context = r, a.callback = n, i[o] = {
							tail: u,
							next: s ? s.next : a
						}, o = t.shift();
					return this
				...
				off: function(t, n, r) {
					...
					if (a = this._callbacks) {
						...
						for (t = t ? t.split(e) : (0, o.default)(u).call(u, a), i = t
							.shift(); i;)
							if (s = a[i], delete a[i], s && (n || r)) {
								for (c = s.tail, s = s.next; s !== c;) f = s.callback, l = s
									.context, (n && f !== n || r && l !== r) && this.on(i,
										f, l), s = s.next;
								i = t.shift()
							} return this
					}
				...
				trigger: function(t) {
					...
					for (c = o.all, t = t.split(e), f = n.call(arguments, 1), r = t
					.shift(); r;) {
						if (i = o[r])
							for (u = i.tail;
		...
		t.exports = function(t) {
			t.GeoPoint = function(e, n) {
				o.isArray(e) ? (t.GeoPoint._validate(e[0], e[1]), this.latitude = e[0], this
					.longitude = e[1]) : o.isObject(e) ? (t.GeoPoint._validate(e.latitude, e
						.longitude), this.latitude = e.latitude, this.longitude = e
					.longitude) : o.isNumber(e) && o.isNumber(n) ? (t.GeoPoint._validate(e,
					n), this.latitude = e, this.longitude = n) : (this.latitude = 0, this
					.longitude = 0);
				var r = this;
				this.__defineGetter__ && this.__defineSetter__ && (this._latitude = this
					.latitude, this._longitude = this.longitude, this.__defineGetter__(
						"latitude",
						function() {
							return r._latitude
		...
		t.exports = function(t) {
			t.ACL = function(e) {
				...
				if (n instanceof t.User ? n = n.id : n instanceof t.Role && (n = "role:" + n
						.getName()), !r.isString(n)) throw new Error(
				...
				n instanceof t.User ? n = n.id : n instanceof t.Role && (n = "role:" + n
					.getName());
				...
				if (e instanceof t.Role && (e = e.getName()), r.isString(e)) return this
					.getReadAccess("role:" + e);
				throw new Error("role must be a AV.Role or a String")
			}, t.ACL.prototype.getRoleWriteAccess = function(e) {
				if (e instanceof t.Role && (e = e.getName()), r.isString(e)) return this
					.getWriteAccess("role:" + e);
				throw new Error("role must be a AV.Role or a String")
			}, t.ACL.prototype.setRoleReadAccess = function(e, n) {
				if (e instanceof t.Role && (e = e.getName()), r.isString(e)) return void this
					.setReadAccess("role:" + e, n);
				throw new Error("role must be a AV.Role or a String")
			}, t.ACL.prototype.setRoleWriteAccess = function(e, n) {
				if (e instanceof t.Role && (e = e.getName()), r.isString(e)) return void this
					.setWriteAccess("role:" + e, n);
				throw new Error("role must be a AV.Role or a String")
			}
		}
	}, function(t, e, n) {
		...
		t.exports = function(t) {
			t.Op = function() {
				...
				_mergeWithPrevious: function(e) {
					if (e) {
						if (e instanceof t.Op.Unset) return new t.Op.Set(this
					.objects());
						if (e instanceof t.Op.Set) return new t.Op.Set(this._estimate(e
							.value()));
						if (e instanceof t.Op.Add) {
							var n;
							return new t.Op.Add((0, i.default)(n = e.objects()).call(n,
								this.objects()))
						}
						throw new Error("Op is invalid after previous op.")
					}
				...
				_estimate: function(t) {
					return t ? (0, i.default)(t).call(t, this.objects()) : s.clone(this
						.objects())
				}
					...
					if (e) {
						...
						return t._arrayEach(this.objects(), function(e) {
							if (e instanceof t.Object && e.id) {
								var r = (0, o.default)(s).call(s, n, function(
								n) {
									return n instanceof t.Object && n
										.id === e.id
								});
								if (r) {
				...
				_mergeWithPrevious: function(e) {
					if (e) {
						...
						if (e instanceof t.Op.Set) return new t.Op.Set(this._estimate(e
							.value()));
						if (e instanceof t.Op.Remove) return new t.Op.Remove(s.union(e
				...
				_estimate: function(e) {
					if (e) {
						...
						return t._arrayEach(this.objects(), function(e) {
							e instanceof t.Object && e.id && (n = s.reject(n,
								function(n) {
									return n instanceof t.Object && n
										.id === e.id
								}))
					...
					var r = this,
						i = function(e) {
							if (e instanceof t.Object) {
								...
								if (r._targetClassName || (r._targetClassName = e
										.className), r._targetClassName !== e.className)
									throw new Error(
										"Tried to create a AV.Relation with 2 different types: " +
										r._targetClassName + " and " + e.className +
										".");
								return e.id
							}
							return e
						};
					this.relationsToAdd = s.uniq((0, u.default)(s).call(s, e, i)), this
						.relationsToRemove = s.uniq((0, u.default)(s).call(s, n, i))
				},
				added: function() {
					var e = this;
				...
				removed: function() {
					var e = this;
					return (0, u.default)(s).call(s, this.relationsToRemove, function(
					n) {
						var r = t.Object._create(e._targetClassName);
						return r.id = n, r
					})
				...
				toJSON: function() {
					var t = null,
						...
						i = null;
					return this.relationsToAdd.length > 0 && (i = (0, u.default)(s)
						.call(s, this.relationsToAdd, r), t = {
							__op: "AddRelation",
							objects: i
						}), this.relationsToRemove.length > 0 && (i = (0, u.default)
						(s).call(s, this.relationsToRemove, r), e = {
							__op: "RemoveRelation",
							objects: i
						}), t && e ? {
						__op: "Batch",
				...
				_mergeWithPrevious: function(e) {
					if (e) {
						...
						if (e instanceof t.Op.Relation) {
							if (e._targetClassName && e._targetClassName !== this
								._targetClassName) throw new Error(
								"Related object must be of class " + e
								._targetClassName + ", but " + this
								._targetClassName + " was passed in.");
							var n = s.union(s.difference(e.relationsToAdd, this
									.relationsToRemove), this.relationsToAdd),
								r = s.union(s.difference(e.relationsToRemove, this
									.relationsToAdd), this.relationsToRemove),
		...
		t.exports = function(t) {
			t.Relation = function(t, e) {
				...
				_ensureParentAndKey: function(t, e) {
					if (this.parent = this.parent || t, this.key = this.key || e, this
						.parent !== t) throw new Error(
				...
				add: function(e) {
					...
					this.parent.set(this.key, n), this.targetClassName = n
						._targetClassName
				},
				remove: function(e) {
					r.isArray(e) || (e = [e]);
				...
				query: function() {
					var e, n;
					return this.targetClassName ? (e = t.Object._getSubclass(this
							.targetClassName), n = new t.Query(e)) : (e = t.Object
							._getSubclass(this.parent.className), n = new t.Query(e), n
							._defaultParams.redirectClassNameForKey = this.key), n
						._addCondition("$relatedTo", "object", this.parent
					._toPointer()), n._addCondition("$relatedTo", "key", this.key), n
				}
			})
		}
	}, function(t, e, n) {
		...
		t.exports = function(t) {
				...
				r = function(t) {
					...
					return e.length = Math.ceil(t.length / 3), o.times(e.length, function(r) {
						var i = t[3 * r],
							...
							u = 3 * r + 1 < t.length,
							s = 3 * r + 2 < t.length;
						e[r] = [n(i >> 2 & 63), n(i << 4 & 48 | o >> 4 & 15), u ? n(o << 2 &
							60 | a >> 6 & 3) : "=", s ? n(63 & a) : "="].join("")
					}), e.join("")
				};
			t.File = function(n, i, a) {
				...
				o.isArray(i) && (this.attributes.metaData.size = i.length, i = {
						base64: r(i)
					}), this._extName = "", this._data = i, this._uploadHeaders = {}, i && i
					.blob && "string" == typeof i.blob.uri && (this._extName = e(i.blob.uri)),
					"undefined" != typeof Blob && i instanceof Blob && (i.size && (this
						.attributes.metaData.size = i.size), i.name && (this._extName = e(i
						.name)));
				var u;
				...
				setACL: function(e) {
					return e instanceof t.ACL ? (this._acl = e, this) : new c(c
						.OTHER_CAUSE, "ACL must be a AV.ACL.")
				},
				name: function() {
				...
				set: function() {
					for (var t = this, e = function(e, n) {
						...
						}, n = arguments.length, r = new Array(n), i = 0; i < n; i++) r[
						i] = arguments[i];
					switch (r.length) {
						case 1:
				...
				destroy: function(t) {
					return this.id ? d("files", null, this.id, "DELETE", null, t) : i
				...
				save: function() {
					...
					if (!this._previousSave)
						if (this._data) {
							...
							this._previousSave = this._fileToken(n, e).then(function(
							r) {
								return r.mime_type && (n = r.mime_type, t.set(
										"mime_type", n)), t._token = r.token, i
									.default.resolve().then(function() {
										var e = t._data;
										if (e && e.base64) return b(e
											.base64, n);
										if (e && e.blob) return !e.blob
											.type && n && (e.blob.type =
												n), e.blob.name || (e
												.blob.name = t.get(
													"name")), e.blob;
										if ("undefined" != typeof Blob &&
											e instanceof Blob) return e;
										throw new TypeError(
											"malformed file data")
									}).then(function(n) {
										var i = o.extend({}, e);
										switch (e.onprogress && (i
						...
						this._previousSave = d("files", null, null, "post", r, e).then(
							function(e) {
				...
				fetch: function(t, e) {
					...
					return d("files", null, this.id, "GET", v(t), e).then(this
						._finishFetch.bind(this))
				},
				_finishFetch: function(e) {
					...
					return n.attributes = {
						...
						delete n.objectId, delete n.metaData, delete n.url, delete n
						.name, delete n.mime_type, delete n.bucket, o.extend(this, n),
						this
				},
				censor: function() {
		...
		t.exports = function(t, e, n) {
			...
			return o("url: %s, file: %o, options: %o", a, u, s), i("upload")(a, u, s).then(function(
				e) {
				...
				var e = t.response;
				throw e && (o(e.status, e.data), t.statusCode = e.status, t.response = e
					.data), t
			})
		}
	}, function(t, e, n) {
		...
		function a(t, e) {
			...
			if (t) {
				...
				return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r ||
					"Set" === r ? d(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/
					.test(r) ? u(t, e) : void 0
			}
		}
		...
		function s(t, e, n) {
			...
			return C("url: %s, file: %o, options: %o", o, a, u), E("upload")(o, a, u).then(function(e) {
				...
				var e = t.response;
				throw e && (C(e.status, e.data), t.statusCode = e.status, t.response = e.data),
					t
			})
		}

		function c(t) {
			var e, n = N(unescape(encodeURIComponent(t))),
				r = "",
				i = o(n);
			try {
				for (i.s(); !(e = i.n()).done;) {
		...
		var l = n(81),
			...
			U = function() {
				function t(e, n, r, i) {
					var o, a, u = this;
					(0, y.default)(this, t), this.uploadInfo = e, this.data = n, this.file = r, this
						.size = void 0, this.offset = 0, this.uploadedChunks = 0;
					var s = c(e.key),
						f = e.upload_url || "https://upload.qiniup.com";
					this.baseURL = (0, j.default)(o = (0, j.default)(a = "".concat(f, "/buckets/"))
							.call(a, e.bucket, "/objects/")).call(o, s, "/uploads"), this.upToken =
				...
				return (0, O.default)(t, [{
					...
					value: function(t, e, n) {
						...
						return T({
							method: "PUT",
							url: (0, j.default)(r = (0, j.default)(i = ""
								.concat(this.baseURL, "/")).call(i, t,
								"/")).call(r, e),
							headers: {
								Authorization: this.upToken
							},
					...
					value: function(t) {
						...
						return T({
							method: "DELETE",
							url: (0, j.default)(e = "".concat(this.baseURL,
								"/")).call(e, t),
							headers: {
								Authorization: this.upToken
							}
					...
					value: function() {
						...
						return this.getUploadId().then(function(n) {
							return function r() {
								return A.default.resolve(t.getChunk()).then(
									function(i) {
										if (i) {
											var o = e.length + 1;
							...
							return t.file.attributes.url = t.uploadInfo.url, t
								.file._bucket = t.uploadInfo.bucket, t.file.id =
								t.uploadInfo.objectId, t.file
						})
					}
				}]), t
			}(),
			k = function(t) {
				...
				return (0, O.default)(e, [{
					...
					value: function() {
						...
						var e = (0, x.default)(t = this.data).call(t, this.offset, this
							.offset + I);
		...
		t.exports = function(t, e, n) {
			var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
			return f(e) && e.size >= 67108864 ? new k(t, e, n, r).upload() : s(t, e, n, r)
		}
	}, function(t, e, n) {
		t.exports = n(230)
	}, function(t, e, n) {
		...
		t.exports = function(t) {
			...
			var b, g, m, y, O, w, j = d(e),
				A = 0;
			if (!j || this === h && u(j))
				for (b = c(e), g = n ? new this(b) : h(b); b > A; A++) w = _ ? v(e[A], A) : e[A], f(
					g, A, w);
			else
				for (y = l(e, j), O = y.next, g = n ? new this : []; !(m = i(O, y)).done; A++) w =
					_ ? a(y, v, [m.value, A], !0) : m.value, f(g, A, w);
			return g.length = A, g
		}
	}, function(t, e, n) {
		var r = n(21),
				...
				a = function(t, n) {
					t.constructor == String ? t = n && "binary" === n.encoding ? o.stringToBytes(t) : r
						.stringToBytes(t) : i(t) ? t = Array.prototype.slice.call(t, 0) : Array.isArray(
							t) || (t = t.toString());
					for (var u = e.bytesToWords(t), s = 8 * t.length, c = 1732584193, f = -271733879,
							l = -1732584194, d = 271733878, h = 0; h < u.length; h++) u[h] = 16711935 &
						(u[h] << 8 | u[h] >>> 24) | 4278255360 & (u[h] << 24 | u[h] >>> 8);
					...
					for (var p = a._ff, v = a._gg, _ = a._hh, b = a._ii, h = 0; h < u.length; h += 16) {
						var g = c,
							...
							y = l,
							O = d;
						c = p(c, f, l, d, u[h + 0], 7, -680876936), d = p(d, c, f, l, u[h + 1], 12, -
								389564586), l = p(l, d, c, f, u[h + 2], 17, 606105819), f = p(f, l, d,
								c, u[h + 3], 22, -1044525330), c = p(c, f, l, d, u[h + 4], 7, -
								176418897), d = p(d, c, f, l, u[h + 5], 12, 1200080426), l = p(l, d, c,
								f, u[h + 6], 17, -1473231341), f = p(f, l, d, c, u[h + 7], 22, -
								45705983), c = p(c, f, l, d, u[h + 8], 7, 1770035416), d = p(d, c, f, l,
								u[h + 9], 12, -1958414417), l = p(l, d, c, f, u[h + 10], 17, -42063),
							f = p(f, l, d, c, u[h + 11], 22, -1990404162), c = p(c, f, l, d, u[h + 12],
								7, 1804603682), d = p(d, c, f, l, u[h + 13], 12, -40341101), l = p(l, d,
								c, f, u[h + 14], 17, -1502002290), f = p(f, l, d, c, u[h + 15], 22,
								1236535329), c = v(c, f, l, d, u[h + 1], 5, -165796510), d = v(d, c, f,
								l, u[h + 6], 9, -1069501632), l = v(l, d, c, f, u[h + 11], 14,
								643717713), f = v(f, l, d, c, u[h + 0], 20, -373897302), c = v(c, f, l,
								d, u[h + 5], 5, -701558691), d = v(d, c, f, l, u[h + 10], 9, 38016083),
							l = v(l, d, c, f, u[h + 15], 14, -660478335), f = v(f, l, d, c, u[h + 4],
								20, -405537848), c = v(c, f, l, d, u[h + 9], 5, 568446438), d = v(d, c,
								f, l, u[h + 14], 9, -1019803690), l = v(l, d, c, f, u[h + 3], 14, -
								187363961), f = v(f, l, d, c, u[h + 8], 20, 1163531501), c = v(c, f, l,
								d, u[h + 13], 5, -1444681467), d = v(d, c, f, l, u[h + 2], 9, -
							51403784), l = v(l, d, c, f, u[h + 7], 14, 1735328473), f = v(f, l, d, c, u[
								h + 12], 20, -1926607734), c = _(c, f, l, d, u[h + 5], 4, -378558), d =
							_(d, c, f, l, u[h + 8], 11, -2022574463), l = _(l, d, c, f, u[h + 11], 16,
								1839030562), f = _(f, l, d, c, u[h + 14], 23, -35309556), c = _(c, f, l,
								d, u[h + 1], 4, -1530992060), d = _(d, c, f, l, u[h + 4], 11,
								1272893353), l = _(l, d, c, f, u[h + 7], 16, -155497632), f = _(f, l, d,
								c, u[h + 10], 23, -1094730640), c = _(c, f, l, d, u[h + 13], 4,
								681279174), d = _(d, c, f, l, u[h + 0], 11, -358537222), l = _(l, d, c,
								f, u[h + 3], 16, -722521979), f = _(f, l, d, c, u[h + 6], 23, 76029189),
							c = _(c, f, l, d, u[h + 9], 4, -640364487), d = _(d, c, f, l, u[h + 12], 11,
								-421815835), l = _(l, d, c, f, u[h + 15], 16, 530742520), f = _(f, l, d,
								c, u[h + 2], 23, -995338651), c = b(c, f, l, d, u[h + 0], 6, -
							198630844), d = b(d, c, f, l, u[h + 7], 10, 1126891415), l = b(l, d, c, f,
								u[h + 14], 15, -1416354905), f = b(f, l, d, c, u[h + 5], 21, -57434055),
							c = b(c, f, l, d, u[h + 12], 6, 1700485571), d = b(d, c, f, l, u[h + 3], 10,
								-1894986606), l = b(l, d, c, f, u[h + 10], 15, -1051523), f = b(f, l, d,
								c, u[h + 1], 21, -2054922799), c = b(c, f, l, d, u[h + 8], 6,
								1873313359), d = b(d, c, f, l, u[h + 15], 10, -30611744), l = b(l, d, c,
								f, u[h + 6], 15, -1560198380), f = b(f, l, d, c, u[h + 13], 21,
								1309151649), c = b(c, f, l, d, u[h + 4], 6, -145523070), d = b(d, c, f,
								l, u[h + 11], 10, -1120210379), l = b(l, d, c, f, u[h + 2], 15,
								718787259), f = b(f, l, d, c, u[h + 9], 21, -343485551), c = c + g >>>
							0, f = f + m >>> 0, l = l + y >>> 0, d = d + O >>> 0
					}
		...
		! function() {
			var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
				n = {
					...
					endian: function(t) {
						if (t.constructor == Number) return 16711935 & n.rotl(t, 8) | 4278255360 & n
							.rotl(t, 24);
					...
					bytesToWords: function(t) {
						for (var e = [], n = 0, r = 0; n < t.length; n++, r += 8) e[r >>> 5] |= t[
							n] << 24 - r % 32;
						return e
					},
					wordsToBytes: function(t) {
						for (var e = [], n = 0; n < 32 * t.length; n += 8) e.push(t[n >>> 5] >>>
							24 - n % 32 & 255);
						return e
					},
					bytesToHex: function(t) {
						for (var e = [], n = 0; n < t.length; n++) e.push((t[n] >>> 4).toString(
							16)), e.push((15 & t[n]).toString(16));
						return e.join("")
					},
					hexToBytes: function(t) {
						for (var e = [], n = 0; n < t.length; n += 2) e.push(parseInt(t.substr(n,
							2), 16));
						return e
					},
					bytesToBase64: function(t) {
						for (var n = [], r = 0; r < t.length; r += 3)
							for (var i = t[r] << 16 | t[r + 1] << 8 | t[r + 2], o = 0; o < 4; o++)
								8 * r + 6 * o <= 8 * t.length ? n.push(e.charAt(i >>> 6 * (3 - o) &
									63)) : n.push("=");
						return n.join("")
					},
					base64ToBytes: function(t) {
						...
						for (var n = [], r = 0, i = 0; r < t.length; i = ++r % 4) 0 != i && n.push((
								e.indexOf(t.charAt(r - 1)) & Math.pow(2, -2 * i + 8) - 1) << 2 *
							i | e.indexOf(t.charAt(r)) >>> 6 - 2 * i);
						return n
					}
				};
			t.exports = n
		...
		function r(t) {
			return "function" == typeof t.readFloatLE && "function" == typeof t.slice && n(t.slice(0,
				0))
		}
		/*!
		...
		var r = n(2),
			...
			o = function(t, e) {
				var n, r;
				(0, i.default)(t).call(t, "base64") < 0 ? r = atob(t) : (0, i.default)(n = t.split(",")[
					0]).call(n, "base64") >= 0 ? (e = e || t.split(",")[0].split(":")[1].split(";")[
					0], r = atob(t.split(",")[1])) : r = unescape(t.split(",")[1]);
		...
		var i = n(2),
			...
			S = m.continueWhile,
			E = function t(e) {
				return v.isArray(e) ? (0, a.default)(e).call(e, t) : x(e) ? v.mapObject(e, t) : v
					.isObject(e) && e._toPointer ? e._toPointer() : e
			},
			C = ["objectId", "createdAt", "updatedAt"],
			T = function(t) {
				if (-1 !== (0, u.default)(C).call(C, t)) throw new Error("key[".concat(t,
					"] is reserved"))
			},
			N = function(t) {
		...
		t.exports = function(t) {
			t.Object = function(e, n) {
				...
				i && (e = v.extend({}, i, e)), n && n.collection && (this.collection = n
						.collection), this._serverData = {}, this._opSetQueue = [{}], this
					._flags = {}, this.attributes = {}, this._hashedJSON = {}, this
					._escapedAttributes = {}, this.cid = v.uniqueId("c"), this.changed = {},
					this._silent = {}, this._pending = {}, this.set(e, {
						silent: !0
					}), this.changed = {}, this._silent = {}, this._pending = {}, this
					._hasData = !0, this._previousAttributes = v.clone(this.attributes), this
				...
				return c.default.resolve().then(function() {
					return g("batch", null, null, "POST", {
						requests: (0, a.default)(v).call(v, t, function(t) {
							...
							return {
								method: "GET",
								path: (0, f.default)(e = "/1.1/classes/"
									.concat(t.className, "/")).call(
									e, t.id)
							}
						})
					}, e)
					...
					var n = (0, a.default)(v).call(v, t, function(t, n) {
						...
						return null === e[n].success ? new _(_.OBJECT_NOT_FOUND,
							"Object not found.") : new _(e[n].error.code, e[
							n].error.error)
					});
					return N(n)
				})
				...
				_toFullJSON: function(e) {
					...
					return t._objectEach(i, function(e, n) {
						...
						i[e] = t
					}), v.has(this, "id") && (i.objectId = this.id), ["createdAt",
						"updatedAt"
					].forEach(function(t) {
						if (v.has(n, t)) {
							var e = n[t];
					...
					}), r && (i.__type = "Object", v.isArray(e) && e.length && (i
						.__type = "Pointer"), i.className = this.className), i
				},
				_refreshCache: function() {
					var e = this;
					e._refreshingCache || (e._refreshingCache = !0, t._objectEach(this
						.attributes,
						function(n, r) {
							n instanceof t.Object ? n._refreshCache() : v
								.isObject(n) && e._resetCacheForKey(r) && e.set(
									r, new t.Op.Set(n), {
										silent: !0
									})
				...
				dirty: function(t) {
					...
					return t ? !!e[t] : !this.id || (0, l.default)(v).call(v, e)
						.length > 0
				},
				dirtyKeys: function() {
					this._refreshCache();
				...
				escape: function(t) {
					...
					return n = y(r) ? "" : v.escape(r.toString()), this
						._escapedAttributes[t] = n, n
				},
				has: function(t) {
				...
				_mergeMagicFields: function(e) {
					...
					return t._arrayEach(r, function(r) {
						e[r] && ("objectId" === r ? n.id = e[r] :
							"createdAt" !== r && "updatedAt" !== r || v
							.isDate(e[r]) ? n[r] = e[r] : n[r] = t
							._parseDate(e[r]), delete e[r])
					}), e
				},
				_startSave: function() {
				...
				_finishSave: function(e) {
					...
					t._traverse(this.attributes, function(e) {
						e instanceof t.Object && e.id && e._hasData && (r[e
							.id] = e)
					});
					var i = v.first(this._opSetQueue);
					this._opSetQueue = v.rest(this._opSetQueue), this._applyOpSet(i,
					...
					this._refreshCache(), this._opSetQueue = u, this._saving = this
						._saving - 1
				},
				...
				_applyOpSet: function(e, n) {
					...
					t._objectEach(e, function(e, i) {
						var a = A(n, i),
							...
							c = u[1],
							f = u[2];
						j(n, i, e._estimate(s, r, i)), c && c[f] === t.Op
							._UNSET && delete c[f]
					})
				},
				_resetCacheForKey: function(e) {
					var n = this.attributes[e];
					if (v.isObject(n) && !(n instanceof t.Object) && !(n instanceof t
							.File)) {
						...
						function(r) {
							...
							if (i) {
								var a = A(n.attributes, e),
									...
									f = u[2],
									l = u[3];
								j(n.attributes, e, i._estimate(s, n, e)), c && c[
									f] === t.Op._UNSET && delete c[f], n
									._resetCacheForKey(l)
							}
						})
				},
				_rebuildAllEstimatedData: function() {
					...
					this.attributes = v.clone(this._serverData), t._arrayEach(this
						._opSetQueue,
						function(n) {
						...
						e.attributes[n] !== t && e.trigger("change:" + n, e, e
							.attributes[n], {})
				...
				set: function(e, n, r) {
					...
					if (v.isObject(e) || y(e) ? (i = v.mapObject(e, function(e, n) {
						...
						}), r = n) : (i = {}, T(e), i[e] = t._decode(n, e)), r = r ||
						{}, !i) return this;
					i instanceof t.Object && (i = i.attributes), r.unset && t
						._objectEach(i, function(e, n) {
							i[n] = new t.Op.Unset
						});
					var o = v.clone(i),
						a = this;
					t._objectEach(o, function(e, n) {
						e instanceof t.Op && (o[n] = e._estimate(a.attributes[
							n], a, n), o[n] === t.Op._UNSET && delete o[
							n])
					...
					return t._arrayEach((0, l.default)(v).call(v, i), function(e) {
						...
						var o = !0;
						n instanceof t.Op.Set && v.isEqual(a.attributes[e], n
							.value) && (o = !1), o && (delete u[e], r
							.silent ? a._silent[e] = !0 : r.changes[e] = !0);
						var s = v.last(a._opSetQueue);
						s[e] = n._mergeWithPrevious(s[e]), a
							._rebuildEstimatedDataForKey(e), o ? (a.changed[e] =
								a.attributes[e], r.silent || (a._pending[e] = !
									0)) : (delete a.changed[e], delete a
								._pending[e])
				...
				increment: function(e, n) {
					return (v.isUndefined(n) || v.isNull(n)) && (n = 1), this.set(e,
				...
				fetch: function() {
					...
					var n = this;
					return g("classes", this.className, this.id, "GET", w(t), e).then(
						function(e) {
							var r = n.parse(e);
							return n._cleanupUnsetKeys(r, (0, l.default)(t) ? O((0,
									l.default)(t)).join(",").split(",") :
								void 0), n._finishFetch(r, !0), n
						})
				},
				_cleanupUnsetKeys: function(t) {
					var e = this,
						n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[
							1] : (0, l.default)(v).call(v, this._serverData);
				...
				save: function(e, n, r) {
					var i, o, a;
					v.isObject(e) || y(e) ? (i = e, a = n) : (i = {}, i[e] = n, a = r),
						a = v.clone(a) || {}, a.wait && (o = v.clone(this.attributes));
					var u = v.clone(a) || {};
					u.wait && (u.silent = !0), i && this.set(i, u);
					var s = this,
						f = [],
						l = [];
					return t.Object._findUnsavedChildren(s, f, l), f.length + l.length >
						1 ? t.Object._deepSaveAsync(this, s, a) : (this._startSave(),
							this._saving = (this._saving || 0) + 1, this
							._allPreviousSaves = this._allPreviousSaves || c.default
							.resolve(), this._allPreviousSaves = this._allPreviousSaves
							.catch(function(t) {}).then(function() {
								var t = s.id ? "PUT" : "POST",
									e = s._getSaveJSON(),
									n = {};
								if ((s._fetchWhenSave || a.fetchWhenSave) && (n
										.new = "true"), a._failOnNotExist && (n
										.failOnNotExist = "true"), a.query) {
									var r;
									if ("function" == typeof a.query._getParams && (
											r = a.query._getParams()) && (n.where =
											r.where), !n.where) {
										throw new Error(
								...
								var c = "classes",
									f = s.className;
								"_User" !== s.className || s.id || (c = "users", f =
									null);
								var l = a._makeRequest || g,
									d = l(c, f, s.id, t, e, a, n);
								return d = d.then(function(t) {
									var e = s.parse(t);
									return a.wait && (e = v.extend(i || {},
											e)), s._finishSave(e), a.wait &&
										s.set(o, u), s
								}, function(t) {
				...
				destroy: function(t) {
					...
					return this.id ? (t.wait || n(), g("classes", this.className, this
						.id, "DELETE", this._flags, t).then(function() {
						return t.wait && n(), e
					})) : n()
				},
				parse: function(e) {
				...
				change: function(e) {
					...
					for (var o = function(t, e) {
						...
						}; !v.isEmpty(this._pending);) this._pending = {}, this.trigger(
							"change", this, e), t._objectEach(this.changed, o), r
						._previousAttributes = v.clone(this.attributes);
					return this._changing = !1, this
				},
				previous: function(t) {
					return arguments.length && this._previousAttributes ? this
						._previousAttributes[t] : null
				},
				...
				validate: function(e) {
					if (v.has(e, "ACL") && !(e.ACL instanceof t.ACL)) throw new _(_
						.OTHER_CAUSE, "ACL must be a AV.ACL.")
				},
				...
				disableBeforeHook: function() {
					this.ignoreHook("beforeSave"), this.ignoreHook("beforeUpdate"), this
						.ignoreHook("beforeDelete")
				},
				disableAfterHook: function() {
					this.ignoreHook("afterSave"), this.ignoreHook("afterUpdate"), this
						.ignoreHook("afterDelete")
				},
				ignoreHook: function(e) {
					if (!v.contains(["beforeSave", "afterSave", "beforeUpdate",
							"afterUpdate", "beforeDelete", "afterDelete"
						], e)) throw new Error("Unsupported hookName: " + e);
				...
				var n = v.groupBy(t, function(t) {
					...
					r = {
						requests: (0, a.default)(v).call(v, n, function(t) {
							...
							return {
								method: "DELETE",
								path: (0, f.default)(e = "/1.1/classes/".concat(t[0]
									.className, "/")).call(e, n),
								body: t[0]._flags
							}
						})
				...
				if (!v.isString(e)) throw new Error(
			...
			}, t.Object._classMap = {}, t.Object._extend = t._extend, t.Object.new = function(e,
				n) {
				...
				return i.extend = function(n) {
						var r;
						if (v.isString(n) || n && v.has(n, "className")) return t.Object.extend
							.apply(i, arguments);
						var o = (0, f.default)(r = [e]).call(r, v.toArray(arguments));
						return t.Object.extend.apply(i, o)
					}, (0, h.default)(i, "query", (0, p.default)(t.Object, "query")), i.new =
					function(t, e) {
						return new i(t, e)
					}, t.Object._classMap[e] = i, i
			}, (0, h.default)(t.Object.prototype, "className", {
				get: function() {
					var t = this._className || this.constructor._LCClassName || this
						.constructor.name;
				...
				t._traverse(e, function(e) {
					return e instanceof t.Object ? void(e.dirty() && n.push(e)) :
						e instanceof t.File ? void(e.id || r.push(e)) : void 0
				})
			}, t.Object._canBeSerializedAsValue = function(e) {
				var n = !0;
				return e instanceof t.Object || e instanceof t.File ? n = !!e.id : v.isArray(
					e) ? t._arrayEach(e, function(e) {
				...
				return u.then(function() {
					return S(function() {
						...
						if (t._arrayEach(f, function(t) {
							...
							}), f = n, 0 === e.length) return c.default.reject(
							new _(_.OTHER_CAUSE,
								"Tried to save a batch with a cycle."));
						var i = c.default.resolve((0, a.default)(v).call(v, e,
								function(t) {
									return t._allPreviousSaves || c.default
										.resolve()
								})),
							o = i.then(function() {
								return g("batch", null, null, "POST", {
									requests: (0, a.default)(v)
										.call(v, e, function(t) {
											var e = t.id ?
												"PUT" : "POST",
												n = t
		...
		function r(t, e) {
			...
			if (null != n) {
				var r, a, u = [],
					...
					c = !1;
				try {
					for (n = n.call(t); !(s = (r = n.next()).done) && (u.push(r.value), !e || u
							.length !== e); s = !0);
				} catch (t) {
					c = !0, a = t
				} finally {
		...
		function r(t, e) {
			...
			if (t) {
				...
				return "Object" === r && t.constructor && (r = t.constructor.name), "Map" === r ||
					"Set" === r ? o(t) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/
					.test(r) ? a(t, e) : void 0
			}
		}
		var i = n(512),
			...
			t.Role = t.Object.extend("_Role", {
				constructor: function(e, n) {
					if (r.isString(e) ? (t.Object.prototype.constructor.call(this, null,
							null), this.setName(e)) : t.Object.prototype.constructor
						.call(this, e, n), n) {
				...
				validate: function(e, n) {
					if ("name" in e && e.name !== this.getName()) {
						var o = e.name;
						if (this.id && this.id !== e.objectId) return new i(i
							.OTHER_CAUSE,
		...
		var r = n(2),
			...
			b = function() {
				...
				return function(e, n) {
					...
					if ("string" != typeof o) throw new l(l.OTHER_CAUSE,
			...
			t.User = t.Object.extend("_User", {
				...
				_mergeMagicFields: function(e) {
					return e.sessionToken && (this._sessionToken = e.sessionToken,
							delete e.sessionToken), t.User.__super__._mergeMagicFields
						.call(this, e)
				},
				...
				_synchronizeAuthData: function(e) {
					if (this.isCurrent()) {
						var n;
						c.isString(e) ? (n = e, e = t.User._authProviders[n]) : n = e
							.getAuthType();
				...
				_handleSaveResult: function(e) {
					return e && !t._config.disableCurrentUser && (this
							._isCurrentUser = !0), this._cleanupAuthData(), this
						._synchronizeAllAuthData(), delete this._serverData.password,
						this._rebuildEstimatedDataForKey("password"), this
						._refreshCache(), !e && !this.isCurrent() || t._config
						.disableCurrentUser ? o.default.resolve() : o.default.resolve(t
							.User._saveCurrentUser(this))
				},
				_linkWith: function(e, n) {
					var r, o = this,
						...
						l = a.sessionToken,
						d = a.user;
					return c.isString(e) ? (r = e, e = t.User._authProviders[e]) : r = e
						.getAuthType(), n ? this.save({
				...
				dissociateAuthData: function(t) {
					return this.unset("authData.".concat(t)), this.save().then(function(
						t) {
						return t._handleSaveResult(!0).then(function() {
							return t
						})
				...
				_isLinked: function(t) {
					var e;
					return e = c.isString(t) ? t : t.getAuthType(), !!(this.get(
						"authData") || {})[e]
				},
				...
				_logOutWith: function(e) {
					this.isCurrent() && (c.isString(e) && (e = t.User._authProviders[
						e]), e && e.deauthenticate && e.deauthenticate())
				},
				signUp: function(t, e) {
					var n = t && t.username || this.get("username");
					if (!n || "" === n) throw new l(l.OTHER_CAUSE,
						"Cannot sign up user with an empty name.");
					var r = t && t.password || this.get("password");
					if (!r || "" === r) throw new l(l.OTHER_CAUSE,
						"Cannot sign up user with an empty password.");
					return this.save(t, e).then(function(t) {
						return t.isAnonymous() && (t.unset("authData.".concat(
								"anonymous")), t._opSetQueue = [{}]), t
							._handleSaveResult(!0).then(function() {
								return t
							})
					})
				},
				...
				logIn: function() {
					var t = this;
					return h("login", null, null, "POST", this.toJSON()).then(function(
						e) {
						var n = t.parse(e);
						return t._finishFetch(n), t._handleSaveResult(!0).then(
							function() {
								return n.smsCode || delete t.attributes
									.smsCode, t
							})
					})
				},
				save: function(e, n, r) {
					...
					return c.isObject(e) || c.isNull(e) || c.isUndefined(e) ? (i = e,
							o = n) : (i = {}, i[e] = n, o = r), o = o || {}, t.Object
						.prototype.save.call(this, i, o).then(function(t) {
				...
				authenticated: function() {
					return console.warn(
							...
							), !!this._sessionToken && !t._config.disableCurrentUser &&
						t.User.current() && t.User.current().id === this.id
				},
				isAuthenticated: function() {
					var e = this;
					return o.default.resolve().then(function() {
						return !!e._sessionToken && t.User
							._fetchUserBySessionToken(e._sessionToken).then(
								function() {
									return !0
								},
								function(t) {
				...
				refreshSessionToken: function(t) {
					var e = this;
					return h("users/".concat(this.id, "/refreshSessionToken"), null,
						null, "PUT", null, t).then(function(t) {
				...
				getRoles: function(e) {
					var n;
					return (0, u.default)(n = t.Relation.reverseQuery("_Role", "users",
						this)).call(n, e)
				}
			}, {
				_currentUser: null,
				...
				signUp: function(e, n, r, i) {
					return r = r || {}, r.username = e, r.password = n, t.Object
						._create("_User").signUp(r, i)
				},
				logIn: function(e, n) {
				...
				_fetchUserBySessionToken: function(e) {
					if (void 0 === e) return o.default.reject(new Error(
				...
				logOut: function() {
					return t._config.disableCurrentUser ? (console.warn(
						...
						), o.default.resolve(null)) : (null !== t.User
						._currentUser && (t.User._currentUser._logOutWithAll(), t
							.User._currentUser._isCurrentUser = !1), t.User
						._currentUserMatchesDisk = !0, t.User._currentUser = null, t
						.localStorage.removeItemAsync(t._getAVPath(t.User
							._CURRENT_USER_KEY)).then(function() {
							return t._refreshSubscriptionId()
						}))
				},
				followerQuery: function(e) {
					if (!e || !c.isString(e)) throw new Error(
					"Invalid user object id.");
					var n = new t.FriendShipQuery("_Follower");
					return n._friendshipTag = "follower", n.equalTo("user", t.Object
						.createWithoutData("_User", e)), n
				},
				followeeQuery: function(e) {
					if (!e || !c.isString(e)) throw new Error(
					"Invalid user object id.");
					var n = new t.FriendShipQuery("_Followee");
					return n._friendshipTag = "followee", n.equalTo("user", t.Object
						.createWithoutData("_User", e)), n
				},
				...
				requestMobilePhoneVerify: function(t) {
					...
					return e.validateToken && (n.validate_token = e.validateToken), h(
				...
				requestChangePhoneNumber: function(t, e, n) {
					...
					return e && (r.ttl = n.ttl), n && n.validateToken && (r
						.validate_token = n.validateToken), h(
						"requestChangePhoneNumber", null, null, "POST", r, n)
				},
				...
				currentAsync: function() {
					return t._config.disableCurrentUser ? (console.warn(
							...
							), o.default.resolve(null)) : t.User._currentUser ? o
						.default.resolve(t.User._currentUser) : t.User
						._currentUserMatchesDisk ? o.default.resolve(t.User
							._currentUser) : t.localStorage.getItemAsync(t._getAVPath(t
							.User._CURRENT_USER_KEY)).then(function(e) {
							if (!e) return null;
							t.User._currentUserMatchesDisk = !0, t.User
								._currentUser = t.Object._create("_User"), t.User
								._currentUser._isCurrentUser = !0;
							var n = JSON.parse(e);
							return t.User._currentUser.id = n._id, delete n._id, t
								.User._currentUser._sessionToken = n._sessionToken,
								delete n._sessionToken, t.User._currentUser
								._finishFetch(n), t.User._currentUser
				...
				current: function() {
					...
					var n = t.localStorage.getItem(t._getAVPath(t.User
						._CURRENT_USER_KEY));
					if (!n) return null;
					t.User._currentUser = t.Object._create("_User"), t.User._currentUser
						._isCurrentUser = !0;
					var r = JSON.parse(n);
					return t.User._currentUser.id = r._id, delete r._id, t.User
						._currentUser._sessionToken = r._sessionToken, delete r
						._sessionToken, t.User._currentUser._finishFetch(r), t.User
						._currentUser._synchronizeAllAuthData(), t.User._currentUser
						._refreshCache(), t.User._currentUser._opSetQueue = [{}], t.User
						._currentUser
				},
				_saveCurrentUser: function(e) {
					var n;
					return n = t.User._currentUser !== e ? t.User.logOut() : o.default
						.resolve(), n.then(function() {
							e._isCurrentUser = !0, t.User._currentUser = e;
							var n = e._toFullJSON();
							return n._id = e.id, n._sessionToken = e._sessionToken,
								t.localStorage.setItemAsync(t._getAVPath(t.User
									._CURRENT_USER_KEY), (0, s.default)(n)).then(
									function() {
				...
				_registerAuthenticationProvider: function(e) {
					t.User._authProviders[e.getAuthType()] = e, !t._config
						.disableCurrentUser && t.User.current() && t.User.current()
						._synchronizeAuthData(e.getAuthType())
				},
		...
		t.exports = function(t) {
			t.Query = function(e) {
				f.isString(e) && (e = t.Object._getSubclass(e)), this.objectClass = e, this
					.className = e.prototype.className, this._where = {}, this._include = [],
					this._select = [], this._limit = -1, this._skip = 0, this
					._defaultParams = {}
			}, t.Query.or = function() {
				...
				return f.isArray(n) ? o.pvalues = n : r = n, p("cloudQuery", null, null, "GET",
					o, r).then(function(e) {
					var n = new t.Query(e.className);
					return {
						results: (0, i.default)(f).call(f, e.results, function(t) {
							var r = n._newObject(e);
							return r._finishFetch && r._finishFetch(n
								._processResult(t), !0), r
						}),
						count: e.count,
				...
				get: function(t, e) {
					...
					if ("" === t) return o.default.reject(new d(d.OBJECT_NOT_FOUND,
						"Object not found."));
					var n = this._newObject();
					n.id = t;
					var r = this._getParams(),
						i = {};
					return (0, a.default)(r) && (i.keys = (0, a.default)(r)), r
						.include && (i.include = r.include), r.includeACL && (i
							.includeACL = r.includeACL), p("classes", this.className, t,
							"GET", g(i), e).then(function(t) {
							if (f.isEmpty(t)) throw new d(d.OBJECT_NOT_FOUND,
								"Object not found.");
				...
				_getParams: function() {
					...
					return this._include.length > 0 && (t.include = this._include.join(
							",")), this._select.length > 0 && (t.keys = this._select
							.join(",")), void 0 !== this._includeACL && (t.returnACL =
							this._includeACL), this._limit >= 0 && (t.limit = this
							._limit), this._skip > 0 && (t.skip = this._skip),
						void 0 !== this._order && (t.order = this._order), t
				},
				_newObject: function(e) {
					return e && e.className ? new t.Object(e.className) : new this
						.objectClass
				},
				_createRequest: function() {
					var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[
						...
						n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[
							2] : "/classes/".concat(this.className);
					if (encodeURIComponent((0, u.default)(t)).length > 2e3) {
						...
						return v({
							...
							throw new d(e.error.code, e.error.error ||
								"Unknown batch error")
						})
					}
					return v({
				...
				_parseResponse: function(t) {
					...
					return (0, i.default)(f).call(f, t.results, function(n) {
						...
						return r._finishFetch && r._finishFetch(e
							._processResult(n), !0), r
					})
				},
				find: function(t) {
				...
				scan: function() {
					var t = this,
						...
						a = this._getParams();
					l("scan %O", a), a.order && (console.warn(
						"The order of the query is ignored for Query#scan. Checkout the orderedBy option of Query#scan."
						), delete a.order), a.skip && (console.warn(
						"The skip option of the query is ignored for Query#scan."
						), delete a.skip), a.limit && (console.warn(
						"The limit option of the query is ignored for Query#scan."
						), delete a.limit), n && (a.scan_key = n), r && (a.limit =
						r);
					var u, s = [];
					return {
						next: function() {
							return s.length ? o.default.resolve({
								done: !1,
								value: s.shift()
							}) : null === u ? o.default.resolve({
								done: !0
							}) : p("scan/classes", t.className, null, "GET", u ?
								f.extend({}, a, {
									cursor: u
								}) : a, i).then(function(e) {
								if (u = e.cursor, e.results.length) {
									t._parseResponse(e).forEach(function(
									t) {
										return s.push(t)
									})
								}
								return null === u && 0 === s.length ? {
									done: !0
								} : {
									done: !1,
									value: s.shift()
				...
				destroyAll: function(e) {
					var n = this;
					return (0, s.default)(n).call(n, e).then(function(n) {
				...
				first: function(t) {
					...
					return n.limit = 1, this._createRequest(n, t).then(function(t) {
						return (0, i.default)(f).call(f, t.results, function(
						t) {
							var n = e._newObject();
							return n._finishFetch && n._finishFetch(e
								._processResult(t), !0), n
						})[0]
					})
				},
				skip: function(t) {
				...
				equalTo: function(e, n) {
					return y(e, "undefined is not a valid key"), y(n,
							"undefined is not a valid value"), this._where[e] = t
						._encode(n), this
				},
				_addCondition: function(e, n, r) {
					return y(e, "undefined is not a valid condition key"), y(n,
							"undefined is not a valid condition"), y(r,
							"undefined is not a valid condition value"), this._where[
						e] || (this._where[e] = {}), this._where[e][n] = t._encode(r),
						this
				},
				...
				matches: function(t, e, n) {
					return this._addCondition(t, "$regex", e), n || (n = ""), e
						.ignoreCase && (n += "i"), e.multiline && (n += "m"), n && n
						.length && this._addCondition(t, "$options", n), this
				},
				...
				addAscending: function(t) {
					return y(t, "undefined is not a valid key"), this._order ? this
						._order += "," + t : this._order = t, this
				},
				...
				near: function(e, n) {
					return n instanceof t.GeoPoint || (n = new t.GeoPoint(n)), this
						._addCondition(e, "$nearSphere", n), this
				},
				...
				withinGeoBox: function(e, n, r) {
					return n instanceof t.GeoPoint || (n = new t.GeoPoint(n)),
						r instanceof t.GeoPoint || (r = new t.GeoPoint(r)), this
						._addCondition(e, "$within", {
							$box: [n, r]
						}), this
				},
				include: function(t) {
					var e = this;
					return y(t, "undefined is not a valid key"), f.forEach(arguments,
						function(t) {
							var n;
							e._include = (0, c.default)(n = e._include).call(n, b(
								t))
						}), this
				},
				includeACL: function() {
				...
				select: function(t) {
					...
					return y(t, "undefined is not a valid key"), f.forEach(arguments,
						function(t) {
							var n;
							e._select = (0, c.default)(n = e._select).call(n, b(t))
						}), this
				},
				each: function(e) {
					...
					i._limit = n.batchSize || 100, i._where = f.clone(this._where), i
						._include = f.clone(this._include), i.ascending("objectId");
					var a = !1;
					return m(function() {
						return !a
					}, function() {
						return (0, s.default)(i).call(i, n).then(function(t) {
		...
		t.exports = function(t) {
			...
			t.LiveQuery = c(u, {
				constructor: function(t, e, n, r) {
					var i = this;
					u.apply(this), this.id = t, this._client = e, this._client.register(
							this), this._queryJSON = n, this._subscriptionId = r, this
						._onMessage = this._dispatch.bind(this), this._onReconnect =
						function() {
							d(i._queryJSON, i._subscriptionId).catch(function(t) {
								return console.error(
									"LiveQuery resubscribe error: ".concat(t
										.message))
							})
						}, e.on("message", this._onMessage), e.on("reconnect", this
							._onReconnect)
				},
				...
				unsubscribe: function() {
					var t = this._client;
					return t.off("message", this._onMessage), t.off("reconnect", this
						._onReconnect), t.deregister(this), l({
						method: "POST",
		...
		t.exports = function(t) {
			t.Cloud = t.Cloud || {}, o.extend(t.Cloud, {
				...
				verifySmsCode: function(t, e) {
					...
					var n = {};
					return o.isString(e) && (n.mobilePhoneNumber = e), u(
						"verifySmsCode", t, null, "POST", n)
				},
				_requestCaptcha: function(t, e) {
					return u("requestCaptcha", null, null, "GET", t, e).then(function(
					t) {
						var e = t.captcha_url;
						return {
		...
		t.exports = function(t) {
			t.Installation = t.Object.extend("_Installation"), t.Push = t.Push || {}, t.Push.send =
				function(t, e) {
					if (t.where && (t.where = t.where._getParams().where), t.where && t.cql)
					throw new Error("Both where and cql can't be set");
					if (t.push_time && (t.push_time = t.push_time.toJSON()), t.expiration_time && (t
							.expiration_time = t.expiration_time.toJSON()), t.expiration_time && t
		...
		t.exports = function(t) {
			...
			t.Status = function(t, e) {
				return this.data = {}, this.inboxType = "default", this.query = null, t &&
					"object" === (0, o.default)(t) ? this.data = t : (t && (this.data.image =
						t), e && (this.data.message = e)), this
				...
				destroy: function(t) {
					return this.id ? u("statuses", null, this.id, "DELETE", t) : i
				...
				send: function() {
					var e = this,
						r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[
							0] : {};
					if (!c(r) && !t.User.current()) throw new Error(
						"Please signin an user.");
					return this.query ? n(r).then(function(t) {
						var n = e.query._getParams();
						n.className = e.query.className;
						var i = {};
						return i.query = n, e.data = e.data || {}, e.data
							.source = e.data.source || t, i.data = e
							._getDataJSON(), i.inboxType = e.inboxType ||
							"default", u("statuses", null, null, "POST", i, r)
					}).then(function(n) {
						return e.id = n.objectId, e.createdAt = t._parseDate(n
							.createdAt), e
					}) : t.Status.sendStatusToFollowers(this, r)
				},
				_finishFetch: function(e) {
					this.id = e.objectId, this.createdAt = t._parseDate(e.createdAt),
						this.updatedAt = t._parseDate(e.updatedAt), this.messageId = e
						.messageId, delete e.messageId, delete e.objectId, delete e
						.createdAt, delete e.updatedAt, this.data = t._decode(e)
				}
				...
				return n(r).then(function(n) {
					...
					var o = {};
					return o.query = i, e.data = e.data || {}, e.data.source = e.data
						.source || n, o.data = e._getDataJSON(), o.inboxType = e
						.inboxType || "default", u("statuses", null, null, "POST", o, r)
						.then(function(n) {
							return e.id = n.objectId, e.createdAt = t._parseDate(n
								.createdAt), e
						})
				...
				return n(i).then(function(n) {
					...
					var a = {};
					return a.query = r, e.data = e.data || {}, e.data.source = e.data
						.source || n, a.data = e._getDataJSON(), a.inboxType =
						"private", e.inboxType = "private", u("statuses", null, null,
							"POST", a, i).then(function(n) {
							return e.id = n.objectId, e.createdAt = t._parseDate(n
								.createdAt), e
						})
				})
				...
				if (a.isString(r) || (o = r), !c(o) && null == n && !t.User.current())
				throw new Error("Please signin an user or pass the owner objectId.");
				return i.default.resolve(n || e(o)).then(function(e) {
					var n = {};
					return n.inboxType = t._encode(r), n.owner = t._encode(e), u(
						"subscribe/statuses/count", null, null, "GET", n, o)
				})
				...
				_getParams: function() {
					...
					return e.owner = t._encode(this._owner), e.inboxType = t._encode(
							this._inboxType), e.sinceId = t._encode(this._sinceId), e
						.maxId = t._encode(this._maxId), e
				}
		...
		t.exports = function(t) {
			t.SearchSortBuilder = function() {
				...
				_createRequest: function(t, e) {
					return u("search/select", null, null, "GET", t || this._getParams(),
						e)
				},
				sid: function(t) {
				...
				highlights: function(t) {
					var e;
					return e = t && a.isString(t) ? a.toArray(arguments) : t, this
						._highlights = e, this
				},
				sortBy: function(t) {
				...
				find: function(t) {
					...
					return this._createRequest(void 0, t).then(function(t) {
						return t.sid ? (e._oldSid = e._sid, e._sid = t.sid) : (e
								._sid = null, e._hitEnd = !0), e._hits = t
							.hits || 0, (0, o.default)(a).call(a, t.results,
								function(n) {
									n.className && (t.className = n.className);
									var r = e._newObject(t);
									return r.appURL = n._app_url, r
										._finishFetch(e._processResult(n), !0),
										r
								})
					})
				},
				_getParams: function() {
					...
					if (delete e.where, this._clazz && (e.clazz = this.className), this
						._sid && (e.sid = this._sid), !this._queryString)
			...
			t.Insight = t.Insight || {}, o.extend(t.Insight, {
				...
				find: function(t) {
					...
					return s({
						...
						return t.error ? i.default.reject(new a(t.code, t
							.error)) : i.default.resolve(t)
					})
				}
			})
		}
		...
		t.exports = function(t) {
			var e = function(e) {
					if (e.user) {
						if (!e.user._sessionToken) throw new Error(
							"authOptions.user is not signed in.");
						return i.default.resolve(e.user)
					}
					return e.sessionToken ? t.User._fetchUserBySessionToken(e.sessionToken) : t.User
						.currentAsync()
				},
				n = function(e) {
					var n = c(e);
			...
			t.Friendship = {
				request: function(n) {
					var r, i, a = arguments.length > 1 && void 0 !== arguments[1] ?
						arguments[1] : {};
					n.friend ? (r = n.friend, i = n.attributes) : r = n;
					var s = o.isString(r) ? t.Object.createWithoutData("_User", r) : r;
				...
				acceptRequest: function(e) {
					...
					return n(a).then(function(e) {
						...
						return u({
							method: "PUT",
							path: "/users/friendshipRequests/" + s +
								"/accept",
							data: {
				...
				declineRequest: function(t) {
					...
					return n(e).then(function(t) {
						...
						return u({
							method: "PUT",
							path: "/users/friendshipRequests/" + r +
								"/decline",
							authOptions: e
						})
					})
		...
		var r = n(2),
			...
			s = n(59),
			c = function(t) {
				return "string" == typeof t ? t : "function" == typeof t.getPayload ? (0, i.default)(t
					.getPayload()) : (0, i.default)(t)
			};
		t.exports = s.Object.extend("_Conversation", {
			constructor: function(t) {
				var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
				s.Object.prototype.constructor.call(this, null, null), this.set("name", t),
					void 0 !== e.isSystem && this.set("sys", !!e.isSystem), void 0 !== e
					.isTransient && this.set("tr", !!e.isTransient)
			},
			getCreator: function() {
				return this.get("c")
			},
			...
			send: function(t, e) {
				...
				return void 0 !== n.toClients && (i.to_peers = n.toClients), void 0 !== n
					.transient && (i.transient = !!n.transient), void 0 !== n.pushData && (i
						.push_data = n.pushData), u("rtm", "messages", null, "POST", i, r)
			},
			broadcast: function(t, e) {
				...
				if (void 0 !== n.pushData && (i.push = n.pushData), void 0 !== n
					.validTill) {
					var a = n.validTill;
		...
		p.Leaderboard = function(t) {
			this.statisticName = t, this.order = void 0, this.updateStrategy = void 0, this
				.versionChangeInterval = void 0, this.version = void 0, this.nextResetAt = void 0,
		...
		p.Leaderboard.createWithoutData = function(t) {
			...
			_finishFetch: function(t) {
				...
				return s.forEach(t, function(t, n) {
					"updatedAt" !== n && "objectId" !== n && ("expiredAt" === n && (
							n = "nextResetAt"), "createdAt" === n && (t = h(t)),
						t && "Date" === t.__type && (t = h(t.iso)), e[n] = t)
				}), this
			},
			fetch: function(t) {
				var e = this;
			...
			_getResults: function(t, e, n) {
				...
				return f({
					method: "GET",
					path: (0, u.default)(r = "/leaderboard/leaderboards/".concat(
						this.statisticName, "/ranks")).call(r, n ? "/".concat(
						n) : ""),
					query: {
						skip: i,
						limit: o,
